...
font = ImageFont.truetype(script_path+'FreePixel.ttf',22)
font_small = ImageFont.truetype(script_path+'04B_08__.TTF', 8)
while True:
    ...
    formatted_float = "£ {:,.2f}".format(data['bpi']['GBP']['rate_float'])

    # Write two lines of text.
    draw.text((x, top),       "BITCOIN [BTC/GBP]:"  ,  font=font_small, fill=255)
    draw.text((x, 10),        str(formatted_float), font=font, fill=255)
